...
// Designed by Vaishak Murali.
  ...
  if($_SESSION['type']=="admin"){
    ...
    $encypass = md5(md5($_SESSION['username']).$password);
    mysqli_query($conn,"UPDATE login SET password='".$encypass."' WHERE useername='".$_SESSION['username']."' AND usertype='".$_SESSION['type']."'");
