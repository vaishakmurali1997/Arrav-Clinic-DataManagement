...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">User Account Details</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="table-responsive">
              ...
              // Designed by Vaishak Murali.
                ...
                $result= mysqli_query($conn,"SELECT useername,usertype FROM login");
               ...
               echo "<table class='table table-striped'>  <tr>
                  ...
                  while ($record = mysqli_fetch_array($result)) {
                    echo "<tr>";
                    echo "<td>".$i."</td>";
                    echo "<td>".$record['useername']."</td>";
                    echo "<td>".$record['usertype']."</td>";
                    echo "<td> &nbsp; &nbsp; <a href='remove.php'>  <i class='glyphicon glyphicon-remove-circle'></i> </a> </td>";
                    echo "</tr>";
                    $i=$i+1;
                  }
                  echo "</table>";
