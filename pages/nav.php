...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="dashboard.php"> Aarav Clinic Data-Management  </a>
    </div>
    <!-- /.navbar-header -->
    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="patientrec.php"><i class="fa fa-table fa-fw"></i>Patient Information</a>
                </li>
                <li>
                    <a href="patient.php"><i class="fa fa-edit fa-fw"></i>Patient Log</a>
                </li>
                <li>
                ...
                <li>
                    <a href="#"><i class="glyphicon glyphicon-usd"></i> Accounts Department<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="payment.php">Record Payment</a>
                        </li>
                        <li>
                            <a href="viewpay.php">Payment Details Monthly</a>
                        </li>
                        <li>
                            <a href="yearpay.php">Payment Details Yearly</a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a href="changeuser.php">Change username</a>
                        </li>
                        <li>
                            <a href="#">Admin privileges<span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li>
                                    <a href="adduser.php">Add user</a>
                                </li>
                                <li>
                                    <a href="removeusr.php">User account details</a>
                                </li>
